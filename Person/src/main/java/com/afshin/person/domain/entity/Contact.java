...
public class Contact {
    ...
    private Customer customerByCustomerfk;
    ...
    public boolean equals(Object o) {
        ...
        if (customerfk != null ? !customerfk.equals(contact.customerfk) : contact.customerfk != null) return false;
    ...
    @JoinColumn(name = "customerfk", referencedColumnName = "customerpk", nullable = false,insertable = false,updatable = false)
    @JsonIgnore
    public Customer getCustomerByCustomerfk() {
        return customerByCustomerfk;
    }
    public void setCustomerByCustomerfk(Customer customerByCustomerfk) {
        this.customerByCustomerfk = customerByCustomerfk;
    }
}