CREATE TABLE `customer` (
                            `customerpk` int(6) NOT NULL AUTO_INCREMENT,
                            `customertypeid` int(3) NOT NULL DEFAULT 1 COMMENT 'نوع مشتری حقیقی - حقوقی - خارجی',
...
CREATE TABLE `contact` (
                           ...
                           KEY `fk_contact_1` (`customerfk`),
                           CONSTRAINT `fk_contact_1` FOREIGN KEY (`customerfk`) REFERENCES `customer` (`customerpk`) ON DELETE NO ACTION ON UPDATE NO ACTION
